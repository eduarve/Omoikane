...
class FreeInventarioTerminalHandler implements ITerminalHandler {
    ...
    public FreeInventarioTerminalHandler(TraspasoEntranteController c) {
        setController(c);
    }
    ...
    @Override
    void setController(TraspasoEntranteController controller) {
        this.controller = controller
    }

    @Override
    TraspasoEntranteController getController() {
        return controller;
    }
