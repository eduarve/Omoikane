 ...
 */
class FreeInventarioTerminalHandler implements omoikane.inventarios.traspasoSaliente.ITerminalHandler {
    private TraspasoSalienteController controller;
    public static final Logger logger = Logger.getLogger(FreeInventarioTerminalHandler.class);

    public FreeInventarioTerminalHandler(TraspasoSalienteController c) {
        setController(c);
    }
    ...
    @Override
    void setController(TraspasoSalienteController controller) {
        this.controller = controller
    }

    @Override
    TraspasoSalienteController getController() {
        return controller;
    }
    ...
    void importData() {
        ...
        TraspasoSalientePropWrapper modelo = getController().modelo;
