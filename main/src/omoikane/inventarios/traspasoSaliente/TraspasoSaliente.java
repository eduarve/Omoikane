...
public class TraspasoSaliente {
    ...
    private List<ItemTraspasoSaliente> items;
    ...
    @OrderColumn
    public List<ItemTraspasoSaliente> getItems() { return items; }

    public void setItems(List<ItemTraspasoSaliente> items) { this.items = items; }
    ...
    public TraspasoSaliente() {
        items = new ArrayList<ItemTraspasoSaliente>();
    }
