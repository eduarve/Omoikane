 ...
 */
@Embeddable
public class ItemTraspasoSaliente {
    ...
    public ItemTraspasoSaliente() {
        this("", "", new BigDecimal("0.00"), new BigDecimal("0.00"));
    }

    public ItemTraspasoSaliente(String codigo, String nombre, BigDecimal conteo, BigDecimal costoUnitario) {
        setCodigo( codigo );
        setNombre( nombre );
        setCantidad(conteo);
