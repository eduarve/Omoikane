...
public class TraspasoEntranteTest {
    ...
    public void traspasoEntranteTest() {
        ...
        testProperties.put("DummyJFXApp.viewBeanToTest", "traspasoEntranteView");
        Application.launch(DummyJFXApp.class);
    }

    @Test
    public void traspasoEntranteCRUDTest() {
        Principal.initJavaFx();
        Locale.setDefault(Locale.US);
        Principal.applicationContext = new ClassPathXmlApplicationContext("applicationContext-test.xml");
        HashMap testProperties = (HashMap) Principal.applicationContext.getBean( "properties" );
        testProperties.put("DummyJFXApp.viewBeanToTest", "traspasoEntranteCRUDView");
        Application.launch(DummyJFXApp.class);
    }
}
