...
public class ListaDePreciosCRUDViewTest {
    static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ListaDePreciosCRUDViewTest.class);
    ...
    public void proveedoresViewTest() {
         ...
         testProperties.put("DummyJFXApp.viewBeanToTest", "listaDePreciosCRUDView");
