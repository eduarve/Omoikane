...
public class DepartamentoCRUDViewTest {
    static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(DepartamentoCRUDViewTest.class);

    @Test
    public void departamentosViewTest() {
         ...
         testProperties.put("DummyJFXApp.viewBeanToTest", "departamentoCRUDView");
