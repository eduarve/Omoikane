...
public class ImpuestosCRUDViewTest {
    static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ImpuestosCRUDViewTest.class);
    ...
    public void proveedoresViewTest() {
         ...
         testProperties.put("DummyJFXApp.viewBeanToTest", "impuestosCRUDView");
